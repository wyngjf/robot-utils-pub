...
# def merge(from_dataclass: Any, into_dataclass: Any):
#     schema = into_dataclass.__class__.Schema(partial=True)
#     return schema.load(
#         dump_data_to_dict(from_dataclass.__class__, from_dataclass),
#         unknown=marshmallow.EXCLUDE, instance=into_dataclass
#     )
